...
- Use bare table names (FCT_ORDERS, not DOORDASH.MARTS.FCT_ORDERS).
...
def generate_sql(question):
    ...
    sql = sql.replace("DOORDASH.MARTS.", "").replace("DOORDASH.", "")
...
question = st.text_input("Enter your question here", 
                         placeholder="e.g. Top 10 restaurants by revenue in Banglore")
